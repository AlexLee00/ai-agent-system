...
- **실 발행 신중**: 신규 작법·유형·모델은 crank 검증 후. 마케팅·Facebook·Instagram 발행은 은퇴 상태이며 secret-store 키만 보존.
- **genre 격리**: it ↔ book 전 구간 분리 — 교차 유입 금지.
- **참여 한도**: 이웃댓글 30건은 각 건마다 공감을 동반하고, 단독 공감 30건을 별도 수행해 총 공감 목표는 60건/일이다.
