...
/**
 * 보너스 인사이트 0~2개 랜덤 선택
 * 최근 7일 이력과 비교하여 중복 회피
 *
 * @param {'pos'|'gems'|'star'} botType
 * @param {string[]} recentHistory — 최근 사용된 보너스 ID 배열
 * @returns {Array<{id, title, instruction, minChars, insertAfter}>}
 */
