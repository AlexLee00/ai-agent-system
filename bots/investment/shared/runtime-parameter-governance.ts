...
const GOVERNANCE_SPECS = [
  ...
  { key: 'runtime_config.luna.stockStrategyProfiles.aggressive.minConfidence.live', tier: 'allow', min: 0.1, max: 0.4, label: '국내장 aggressive live 최소 확신도' },
...
function resolveCurrentValue(key) {
  ...
  const lookup = {
    ...
    'runtime_config.luna.stockStrategyProfiles.aggressive.minConfidence.live': runtime.luna?.stockStrategyProfiles?.aggressive?.minConfidence?.live,
