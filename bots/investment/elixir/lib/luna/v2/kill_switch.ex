defmodule Luna.V2.KillSwitch do
  ...
  def position_watch_crypto_realtime_ms, do: Application.get_env(:luna, :position_watch_crypto_realtime_ms, 15_000)
  def position_watch_stock_realtime_ms, do: Application.get_env(:luna, :position_watch_stock_realtime_ms, 15_000)
  def position_watch_stock_offhours_ms, do: Application.get_env(:luna, :position_watch_stock_offhours_ms, 300_000)
  def position_watch_fallback_ms, do: Application.get_env(:luna, :position_watch_fallback_ms, 60_000)
