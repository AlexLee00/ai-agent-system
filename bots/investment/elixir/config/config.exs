...
config :luna,
  ...
  position_watch_idle_ms: String.to_integer(System.get_env("LUNA_POSITION_WATCH_IDLE_MS", "60000")),
  position_watch_crypto_realtime_ms: String.to_integer(System.get_env("LUNA_POSITION_WATCH_CRYPTO_REALTIME_MS", "15000")),
  position_watch_stock_realtime_ms: String.to_integer(System.get_env("LUNA_POSITION_WATCH_STOCK_REALTIME_MS", "15000")),
  position_watch_stock_offhours_ms: String.to_integer(System.get_env("LUNA_POSITION_WATCH_STOCK_OFFHOURS_MS", "300000")),
  position_watch_fallback_ms: String.to_integer(System.get_env("LUNA_POSITION_WATCH_FALLBACK_MS", "60000")),
