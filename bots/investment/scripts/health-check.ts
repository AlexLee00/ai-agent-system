      ...
      if (hsm.canAlert(state, key)) {
        ...
        issues.push({
          ...
          meta: {
            ...
            remediationNextCommand: remediation?.remediationNextCommand || remediationFlat?.nextCommand || remediationSummary?.nextCommand || null,
            ...
            remediationCommands,
            remediationActionReportCommand: remediation?.remediationActionReportCommand || remediationFlat?.actionReportCommand || remediationActions?.reportCommand || remediationCommands?.report || null,
            remediationActionHistoryCommand: remediation?.remediationActionHistoryCommand || remediationFlat?.actionHistoryCommand || remediationActions?.historyCommand || remediationCommands?.history || null,
            remediationActionRefreshCommand: remediation?.remediationActionRefreshCommand || remediationFlat?.actionRefreshCommand || remediationActions?.refreshCommand || remediationFlat?.refreshCommand || remediationCommands?.refresh || null,
            remediationActionHygieneCommand: remediation?.remediationActionHygieneCommand || remediationFlat?.actionHygieneCommand || remediationActions?.hygieneCommand || remediationCommands?.hygiene || null,
            remediationActionNormalizeDryRunCommand: remediation?.remediationActionNormalizeDryRunCommand || remediationFlat?.actionNormalizeDryRunCommand || remediationActions?.normalizeDryRunCommand || remediationCommands?.normalizeDryRun || null,
            remediationActionNormalizeApplyCommand: remediation?.remediationActionNormalizeApplyCommand || remediationFlat?.actionNormalizeApplyCommand || remediationActions?.normalizeApplyCommand || remediationCommands?.normalizeApply || null,
            remediationActionRetireDryRunCommand: remediation?.remediationActionRetireDryRunCommand || remediationFlat?.actionRetireDryRunCommand || remediationActions?.retireDryRunCommand || remediationCommands?.retireDryRun || null,
            remediationActionRetireApplyCommand: remediation?.remediationActionRetireApplyCommand || remediationFlat?.actionRetireApplyCommand || remediationActions?.retireApplyCommand || remediationCommands?.retireApply || null,
