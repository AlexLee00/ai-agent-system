...
async function storeDailyFeedbackRag(dateKst, feedback, analystAccuracy, screeningSummary, reevaluationSummary, minOrderPressureSummary, learningLoopSummary, positionStrategyAuditSummary, positionStrategyHygieneSummary, positionStrategyRemediationSummary, positionStrategyRemediationHistorySummary) {
  ...
  await rag.store('trades', content, {
    ...
    position_strategy_remediation_refresh: remediationFlat?.refresh || resolvedRemediationRefreshState,
    position_strategy_remediation_status: positionStrategyRemediationSummary?.remediationStatus || remediationFlat?.status || remediationSummary?.status || null,
    position_strategy_remediation_headline: positionStrategyRemediationSummary?.remediationHeadline || remediationFlat?.headline || remediationSummary?.headline || null,
    position_strategy_remediation_counts: positionStrategyRemediationSummary?.remediationCounts || remediationFlat?.counts || remediationSummary?.counts || {},
    position_strategy_remediation_recommended_exchange: positionStrategyRemediationSummary?.remediationRecommendedExchange || remediationFlat?.recommendedExchange || remediationSummary?.recommendedExchange || null,
    position_strategy_remediation_next_command: positionStrategyRemediationSummary?.remediationNextCommand || remediationFlat?.nextCommand || remediationSummary?.nextCommand || null,
    position_strategy_remediation_next_command_transition: positionStrategyRemediationSummary?.remediationNextCommandTransition || remediationFlat?.nextCommandTransition || remediationSummary?.nextCommandTransition || positionStrategyRemediationHistorySummary?.nextCommandTransition || {},
    position_strategy_remediation_action_report_command: positionStrategyRemediationSummary?.remediationActionReportCommand || remediationFlat?.actions?.reportCommand || remediationFlat?.commands?.report || remediationSummary?.actions?.reportCommand || null,
    position_strategy_remediation_action_history_command: positionStrategyRemediationSummary?.remediationActionHistoryCommand || remediationFlat?.actions?.historyCommand || remediationFlat?.commands?.history || remediationSummary?.actions?.historyCommand || null,
    position_strategy_remediation_action_refresh_command: positionStrategyRemediationSummary?.remediationActionRefreshCommand || remediationFlat?.actions?.refreshCommand || remediationFlat?.refreshCommand || remediationFlat?.commands?.refresh || remediationSummary?.actions?.refreshCommand || null,
    position_strategy_remediation_action_hygiene_command: positionStrategyRemediationSummary?.remediationActionHygieneCommand || remediationFlat?.actions?.hygieneCommand || remediationFlat?.commands?.hygiene || remediationSummary?.actions?.hygieneCommand || null,
    position_strategy_remediation_action_normalize_dry_run_command: positionStrategyRemediationSummary?.remediationActionNormalizeDryRunCommand || remediationFlat?.actions?.normalizeDryRunCommand || remediationFlat?.commands?.normalizeDryRun || remediationSummary?.actions?.normalizeDryRunCommand || null,
    position_strategy_remediation_action_normalize_apply_command: positionStrategyRemediationSummary?.remediationActionNormalizeApplyCommand || remediationFlat?.actions?.normalizeApplyCommand || remediationFlat?.commands?.normalizeApply || remediationSummary?.actions?.normalizeApplyCommand || null,
    position_strategy_remediation_action_retire_dry_run_command: positionStrategyRemediationSummary?.remediationActionRetireDryRunCommand || remediationFlat?.actions?.retireDryRunCommand || remediationFlat?.commands?.retireDryRun || remediationSummary?.actions?.retireDryRunCommand || null,
    position_strategy_remediation_action_retire_apply_command: positionStrategyRemediationSummary?.remediationActionRetireApplyCommand || remediationFlat?.actions?.retireApplyCommand || remediationFlat?.commands?.retireApply || remediationSummary?.actions?.retireApplyCommand || null,
...
async function runDailyTradeFeedback({ dateKst, dryRun = false }) {
  ...
  if (!dryRun) {
    try {
      ...
      await publishAlert({
        ...
        payload: { dateKst, feedback, analystAccuracy, screeningSummary, reevaluationSummary, minOrderPressureSummary, learningLoopSummary, positionStrategyAuditSummary, positionStrategyHygieneSummary, positionStrategyRemediationSummary, positionStrategyRemediationHistorySummary, remediationFlat, remediationSummary, remediationStatus: positionStrategyRemediationSummary?.remediationStatus || remediationFlat?.status || remediationSummary?.status || null, remediationHeadline: positionStrategyRemediationSummary?.remediationHeadline || remediationFlat?.headline || remediationSummary?.headline || null, remediationCounts: positionStrategyRemediationSummary?.remediationCounts || remediationFlat?.counts || remediationSummary?.counts || null, remediationRecommendedExchange: positionStrategyRemediationSummary?.remediationRecommendedExchange || remediationFlat?.recommendedExchange || remediationSummary?.recommendedExchange || null, remediationDuplicateManaged: positionStrategyRemediationSummary?.remediationDuplicateManaged ?? remediationFlat?.duplicateManaged ?? remediationSummary?.counts?.duplicateManaged ?? null, remediationOrphanProfiles: positionStrategyRemediationSummary?.remediationOrphanProfiles ?? remediationFlat?.orphanProfiles ?? remediationSummary?.counts?.orphanProfiles ?? null, remediationUnmatchedManaged: positionStrategyRemediationSummary?.remediationUnmatchedManaged ?? remediationFlat?.unmatchedManaged ?? remediationSummary?.counts?.unmatchedManaged ?? null, remediationTrend: remediationFlat?.trend || remediationSummary?.trend || positionStrategyRemediationSummary?.remediationTrend || null, remediationRefreshState: remediationFlat?.refresh || remediationSummary?.refreshState || remediationRefreshState, remediationActions: remediationFlat?.actions || remediationSummary?.actions || positionStrategyRemediationSummary?.remediationActions || null, remediationCommands: remediationFlat?.commands || remediationSummary?.commands || null, remediationActionReportCommand: positionStrategyRemediationSummary?.remediationActionReportCommand || remediationFlat?.actions?.reportCommand || remediationFlat?.commands?.report || remediationSummary?.actions?.reportCommand || null, remediationActionHistoryCommand: positionStrategyRemediationSummary?.remediationActionHistoryCommand || remediationFlat?.actions?.historyCommand || remediationFlat?.commands?.history || remediationSummary?.actions?.historyCommand || null, remediationActionRefreshCommand: positionStrategyRemediationSummary?.remediationActionRefreshCommand || remediationFlat?.actions?.refreshCommand || remediationFlat?.refreshCommand || remediationFlat?.commands?.refresh || remediationSummary?.actions?.refreshCommand || null, remediationActionHygieneCommand: positionStrategyRemediationSummary?.remediationActionHygieneCommand || remediationFlat?.actions?.hygieneCommand || remediationFlat?.commands?.hygiene || remediationSummary?.actions?.hygieneCommand || null, remediationActionNormalizeDryRunCommand: positionStrategyRemediationSummary?.remediationActionNormalizeDryRunCommand || remediationFlat?.actions?.normalizeDryRunCommand || remediationFlat?.commands?.normalizeDryRun || remediationSummary?.actions?.normalizeDryRunCommand || null, remediationActionNormalizeApplyCommand: positionStrategyRemediationSummary?.remediationActionNormalizeApplyCommand || remediationFlat?.actions?.normalizeApplyCommand || remediationFlat?.commands?.normalizeApply || remediationSummary?.actions?.normalizeApplyCommand || null, remediationActionRetireDryRunCommand: positionStrategyRemediationSummary?.remediationActionRetireDryRunCommand || remediationFlat?.actions?.retireDryRunCommand || remediationFlat?.commands?.retireDryRun || remediationSummary?.actions?.retireDryRunCommand || null, remediationActionRetireApplyCommand: positionStrategyRemediationSummary?.remediationActionRetireApplyCommand || remediationFlat?.actions?.retireApplyCommand || remediationFlat?.commands?.retireApply || remediationSummary?.actions?.retireApplyCommand || null, remediationReportCommand: remediationFlat?.commands?.report || remediationSummary?.commands?.report || null, remediationHistoryCommand: remediationFlat?.commands?.history || remediationSummary?.commands?.history || null, remediationRefreshCommand: positionStrategyRemediationSummary?.remediationRefreshCommand || remediationFlat?.refreshCommand || remediationFlat?.refresh?.command || remediationFlat?.commands?.refresh || remediationSummary?.commands?.refresh || null, remediationNormalizeDryRunCommand: remediationFlat?.commands?.normalizeDryRun || remediationSummary?.commands?.normalizeDryRun || null, remediationNormalizeApplyCommand: remediationFlat?.commands?.normalizeApply || remediationSummary?.commands?.normalizeApply || null, remediationRetireDryRunCommand: remediationFlat?.commands?.retireDryRun || remediationSummary?.commands?.retireDryRun || null, remediationRetireApplyCommand: remediationFlat?.commands?.retireApply || remediationSummary?.commands?.retireApply || null, remediationNextCommand: positionStrategyRemediationSummary?.remediationNextCommand || remediationFlat?.nextCommand || remediationSummary?.nextCommand || null, remediationNextCommandTransition: positionStrategyRemediationSummary?.remediationNextCommandTransition || remediationFlat?.nextCommandTransition || remediationFlat?.trend?.nextCommandTransition || remediationSummary?.nextCommandTransition || null, remediationNextCommandChanged: positionStrategyRemediationSummary?.remediationNextCommandChanged ?? remediationFlat?.nextCommandChanged ?? remediationSummary?.trend?.nextCommandChanged ?? null, remediationNextCommandPrevious: positionStrategyRemediationSummary?.remediationNextCommandPrevious || remediationFlat?.nextCommandPrevious || remediationSummary?.nextCommandTransition?.previous || null, remediationNextCommandCurrent: positionStrategyRemediationSummary?.remediationNextCommandCurrent || remediationFlat?.nextCommandCurrent || remediationSummary?.nextCommandTransition?.current || null, hygieneRemediationPlan },
      });
      await dailyFeedbackMemory.remember(finalMessage, 'episodic', {
        ...
        metadata: {
          ...
          remediationSummaryStatus: positionStrategyRemediationSummary?.remediationStatus || remediationFlat?.status || remediationSummary?.status || null,
          remediationSummaryHeadline: positionStrategyRemediationSummary?.remediationHeadline || remediationFlat?.headline || remediationSummary?.headline || null,
          remediationReportCommand: positionStrategyRemediationSummary?.remediationActionReportCommand || remediationFlat?.actions?.reportCommand || remediationFlat?.commands?.report || remediationSummary?.commands?.report || hygieneRemediationPlan?.remediationReportCommand || null,
          remediationHistoryCommand: positionStrategyRemediationSummary?.remediationActionHistoryCommand || remediationFlat?.actions?.historyCommand || remediationFlat?.commands?.history || remediationSummary?.commands?.history || null,
          remediationRefreshPlanCommand: positionStrategyRemediationSummary?.remediationActionRefreshCommand || remediationFlat?.actions?.refreshCommand || remediationFlat?.refreshCommand || remediationFlat?.commands?.refresh || remediationSummary?.commands?.refresh || null,
          remediationNormalizeDryRunCommand: positionStrategyRemediationSummary?.remediationActionNormalizeDryRunCommand || remediationFlat?.actions?.normalizeDryRunCommand || remediationFlat?.commands?.normalizeDryRun || remediationSummary?.commands?.normalizeDryRun || null,
          remediationNormalizeApplyCommand: positionStrategyRemediationSummary?.remediationActionNormalizeApplyCommand || remediationFlat?.actions?.normalizeApplyCommand || remediationFlat?.commands?.normalizeApply || remediationSummary?.commands?.normalizeApply || null,
          remediationRetireDryRunCommand: positionStrategyRemediationSummary?.remediationActionRetireDryRunCommand || remediationFlat?.actions?.retireDryRunCommand || remediationFlat?.commands?.retireDryRun || remediationSummary?.commands?.retireDryRun || null,
          remediationRetireApplyCommand: positionStrategyRemediationSummary?.remediationActionRetireApplyCommand || remediationFlat?.actions?.retireApplyCommand || remediationFlat?.commands?.retireApply || remediationSummary?.commands?.retireApply || null,
          remediationTrendHistoryCount: positionStrategyRemediationSummary?.remediationTrendHistoryCount ?? remediationFlat?.trendHistoryCount ?? remediationFlat?.trend?.historyCount ?? remediationSummary?.trend?.historyCount ?? null,
          remediationTrendChanged: positionStrategyRemediationSummary?.remediationTrendChanged ?? remediationFlat?.trendChanged ?? remediationFlat?.trend?.statusChanged ?? remediationSummary?.trend?.statusChanged ?? null,
          remediationTrendNextChanged: positionStrategyRemediationSummary?.remediationTrendNextChanged ?? remediationFlat?.trendNextChanged ?? remediationFlat?.nextCommandChanged ?? remediationSummary?.trend?.nextCommandChanged ?? null,
          remediationNextCommand: positionStrategyRemediationSummary?.remediationNextCommand || remediationFlat?.nextCommand || remediationSummary?.nextCommand || positionStrategyRemediationSummary?.remediationActions?.nextCommand || null,
          remediationNextCommandPrevious: positionStrategyRemediationSummary?.remediationNextCommandPrevious || remediationFlat?.nextCommandPrevious || remediationSummary?.nextCommandTransition?.previous || positionStrategyRemediationSummary?.remediationTrend?.nextCommandTransition?.previous || null,
          remediationNextCommandCurrent: positionStrategyRemediationSummary?.remediationNextCommandCurrent || remediationFlat?.nextCommandCurrent || remediationSummary?.nextCommandTransition?.current || positionStrategyRemediationSummary?.remediationTrend?.nextCommandTransition?.current || null,
        },
      }).catch(() => {});
  ...
  return {
    ...
    remediationCounts: positionStrategyRemediationSummary?.remediationCounts || remediationFlat?.counts || remediationSummary?.counts || null,
    ...
    remediationDuplicateManaged: positionStrategyRemediationSummary?.remediationDuplicateManaged ?? remediationFlat?.duplicateManaged ?? remediationSummary?.counts?.duplicateManaged ?? null,
    remediationOrphanProfiles: positionStrategyRemediationSummary?.remediationOrphanProfiles ?? remediationFlat?.orphanProfiles ?? remediationSummary?.counts?.orphanProfiles ?? null,
    remediationUnmatchedManaged: positionStrategyRemediationSummary?.remediationUnmatchedManaged ?? remediationFlat?.unmatchedManaged ?? remediationSummary?.counts?.unmatchedManaged ?? null,
    remediationTrend: remediationFlat?.trend || remediationSummary?.trend || positionStrategyRemediationSummary?.remediationTrend || null,
    remediationTrendHistoryCount: positionStrategyRemediationSummary?.remediationTrendHistoryCount ?? remediationFlat?.trendHistoryCount ?? remediationSummary?.trend?.historyCount ?? null,
    remediationTrendChanged: positionStrategyRemediationSummary?.remediationTrendChanged ?? remediationFlat?.trendChanged ?? remediationSummary?.trend?.statusChanged ?? null,
    remediationTrendNextChanged: positionStrategyRemediationSummary?.remediationTrendNextChanged ?? remediationFlat?.trendNextChanged ?? remediationSummary?.trend?.nextCommandChanged ?? null,
    remediationTrendAgeMinutes: positionStrategyRemediationSummary?.remediationTrendAgeMinutes ?? remediationFlat?.trendAgeMinutes ?? remediationSummary?.trend?.ageMinutes ?? null,
    remediationTrendStale: positionStrategyRemediationSummary?.remediationTrendStale ?? remediationFlat?.trendStale ?? remediationSummary?.trend?.stale ?? null,
    remediationTrendDuplicateDelta: positionStrategyRemediationSummary?.remediationTrendDuplicateDelta ?? remediationFlat?.trendDuplicateDelta ?? remediationSummary?.trend?.duplicateDelta ?? null,
    remediationTrendOrphanDelta: positionStrategyRemediationSummary?.remediationTrendOrphanDelta ?? remediationFlat?.trendOrphanDelta ?? remediationSummary?.trend?.orphanDelta ?? null,
    remediationTrendUnmatchedDelta: positionStrategyRemediationSummary?.remediationTrendUnmatchedDelta ?? remediationFlat?.trendUnmatchedDelta ?? remediationSummary?.trend?.unmatchedDelta ?? null,
    remediationRefreshState: remediationFlat?.refresh || remediationSummary?.refreshState || remediationRefreshState,
    remediationRefreshNeeded: positionStrategyRemediationSummary?.remediationRefreshNeeded ?? remediationFlat?.refresh?.needed ?? remediationSummary?.refreshState?.needed ?? null,
    remediationRefreshStale: positionStrategyRemediationSummary?.remediationRefreshStale ?? remediationFlat?.refresh?.stale ?? remediationSummary?.refreshState?.stale ?? null,
    remediationRefreshReason: positionStrategyRemediationSummary?.remediationRefreshReason || remediationFlat?.refresh?.reason || remediationSummary?.refreshState?.reason || null,
    remediationRefreshCommand: positionStrategyRemediationSummary?.remediationRefreshCommand || remediationFlat?.refreshCommand || remediationFlat?.refresh?.command || remediationFlat?.commands?.refresh || remediationSummary?.commands?.refresh || remediationSummary?.refreshState?.command || null,
    remediationCommands: remediationFlat?.commands || remediationSummary?.commands || null,
    remediationActionReportCommand: positionStrategyRemediationSummary?.remediationActionReportCommand || remediationFlat?.actions?.reportCommand || remediationFlat?.commands?.report || remediationSummary?.actions?.reportCommand || null,
    remediationActionHistoryCommand: positionStrategyRemediationSummary?.remediationActionHistoryCommand || remediationFlat?.actions?.historyCommand || remediationFlat?.commands?.history || remediationSummary?.actions?.historyCommand || null,
    remediationActionRefreshCommand: positionStrategyRemediationSummary?.remediationActionRefreshCommand || remediationFlat?.actions?.refreshCommand || remediationFlat?.refreshCommand || remediationFlat?.commands?.refresh || remediationSummary?.actions?.refreshCommand || null,
    remediationActionHygieneCommand: positionStrategyRemediationSummary?.remediationActionHygieneCommand || remediationFlat?.actions?.hygieneCommand || remediationFlat?.commands?.hygiene || remediationSummary?.actions?.hygieneCommand || null,
    remediationActionNormalizeDryRunCommand: positionStrategyRemediationSummary?.remediationActionNormalizeDryRunCommand || remediationFlat?.actions?.normalizeDryRunCommand || remediationFlat?.commands?.normalizeDryRun || remediationSummary?.actions?.normalizeDryRunCommand || null,
    remediationActionNormalizeApplyCommand: positionStrategyRemediationSummary?.remediationActionNormalizeApplyCommand || remediationFlat?.actions?.normalizeApplyCommand || remediationFlat?.commands?.normalizeApply || remediationSummary?.actions?.normalizeApplyCommand || null,
    remediationActionRetireDryRunCommand: positionStrategyRemediationSummary?.remediationActionRetireDryRunCommand || remediationFlat?.actions?.retireDryRunCommand || remediationFlat?.commands?.retireDryRun || remediationSummary?.actions?.retireDryRunCommand || null,
    remediationActionRetireApplyCommand: positionStrategyRemediationSummary?.remediationActionRetireApplyCommand || remediationFlat?.actions?.retireApplyCommand || remediationFlat?.commands?.retireApply || remediationSummary?.actions?.retireApplyCommand || null,
    remediationReportCommand: remediationFlat?.commands?.report || remediationSummary?.commands?.report || null,
    remediationHistoryCommand: remediationFlat?.commands?.history || remediationSummary?.commands?.history || null,
    remediationNormalizeDryRunCommand: remediationFlat?.commands?.normalizeDryRun || remediationSummary?.commands?.normalizeDryRun || null,
    remediationNormalizeApplyCommand: remediationFlat?.commands?.normalizeApply || remediationSummary?.commands?.normalizeApply || null,
    remediationRetireDryRunCommand: remediationFlat?.commands?.retireDryRun || remediationSummary?.commands?.retireDryRun || null,
    remediationRetireApplyCommand: remediationFlat?.commands?.retireApply || remediationSummary?.commands?.retireApply || null,
    remediationNextCommand: positionStrategyRemediationSummary?.remediationNextCommand || remediationFlat?.nextCommand || remediationSummary?.nextCommand || null,
    remediationNextCommandTransition: positionStrategyRemediationSummary?.remediationNextCommandTransition || remediationFlat?.nextCommandTransition || remediationSummary?.nextCommandTransition || null,
    remediationNextCommandChanged: positionStrategyRemediationSummary?.remediationNextCommandChanged ?? remediationFlat?.nextCommandChanged ?? remediationSummary?.trend?.nextCommandChanged ?? null,
    remediationNextCommandPrevious: positionStrategyRemediationSummary?.remediationNextCommandPrevious || remediationFlat?.nextCommandPrevious || remediationSummary?.nextCommandTransition?.previous || null,
    remediationNextCommandCurrent: positionStrategyRemediationSummary?.remediationNextCommandCurrent || remediationFlat?.nextCommandCurrent || remediationSummary?.nextCommandTransition?.current || null,
