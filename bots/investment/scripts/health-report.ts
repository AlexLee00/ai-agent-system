...
async function buildReport() {
  ...
  const report = {
    ...
    positionStrategyRemediationStatus: positionStrategyRemediation?.remediationSummary?.status || null,
    positionStrategyRemediationHeadline: positionStrategyRemediation?.remediationSummary?.headline || null,
    positionStrategyRemediationCounts: positionStrategyRemediation?.remediationSummary?.counts || null,
    positionStrategyRemediationRecommendedExchange: positionStrategyRemediation?.remediationSummary?.recommendedExchange || null,
    positionStrategyRemediationDuplicateManaged: positionStrategyRemediation?.remediationSummary?.counts?.duplicateManaged ?? null,
    positionStrategyRemediationOrphanProfiles: positionStrategyRemediation?.remediationSummary?.counts?.orphanProfiles ?? null,
    positionStrategyRemediationUnmatchedManaged: positionStrategyRemediation?.remediationSummary?.counts?.unmatchedManaged ?? null,
    positionStrategyRemediationHistory,
    ...
    positionStrategyRemediationNextCommand: positionStrategyRemediation?.remediationSummary?.nextCommand || null,
