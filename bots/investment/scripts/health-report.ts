...
async function buildReport() {
  ...
  const report = {
    ...
    positionStrategyRemediationRefreshNeeded: positionStrategyRemediation?.remediationRefreshNeeded ?? null,
    positionStrategyRemediationRefreshStale: positionStrategyRemediation?.remediationRefreshStale ?? null,
    positionStrategyRemediationRefreshReason: positionStrategyRemediation?.remediationRefreshReason || null,
    positionStrategyRemediationRefreshCommand: positionStrategyRemediation?.remediationRefreshCommand || null,
