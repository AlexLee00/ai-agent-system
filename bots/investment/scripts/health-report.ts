...
async function buildReport() {
  ...
  const report = {
    ...
    positionStrategyRemediationTrendHistoryCount: positionStrategyRemediation?.remediationTrendHistoryCount ?? null,
    positionStrategyRemediationTrendChanged: positionStrategyRemediation?.remediationTrendChanged ?? null,
    positionStrategyRemediationTrendNextChanged: positionStrategyRemediation?.remediationTrendNextChanged ?? null,
    positionStrategyRemediationTrendAgeMinutes: positionStrategyRemediation?.remediationTrendAgeMinutes ?? null,
    positionStrategyRemediationTrendStale: positionStrategyRemediation?.remediationTrendStale ?? null,
    positionStrategyRemediationTrendLastRecordedAt: positionStrategyRemediation?.remediationTrendLastRecordedAt || null,
    positionStrategyRemediationTrendDuplicateDelta: positionStrategyRemediation?.remediationTrendDuplicateDelta ?? null,
    positionStrategyRemediationTrendOrphanDelta: positionStrategyRemediation?.remediationTrendOrphanDelta ?? null,
    positionStrategyRemediationTrendUnmatchedDelta: positionStrategyRemediation?.remediationTrendUnmatchedDelta ?? null,
