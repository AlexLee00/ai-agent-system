...
async function buildReport() {
  ...
  const report = {
    ...
    positionStrategyRemediationActionReportCommand: positionStrategyRemediation?.remediationActionReportCommand || positionStrategyRemediation?.remediationFlat?.actions?.reportCommand || null,
    positionStrategyRemediationActionHistoryCommand: positionStrategyRemediation?.remediationActionHistoryCommand || positionStrategyRemediation?.remediationFlat?.actions?.historyCommand || null,
    positionStrategyRemediationActionRefreshCommand: positionStrategyRemediation?.remediationActionRefreshCommand || positionStrategyRemediation?.remediationFlat?.actions?.refreshCommand || null,
    positionStrategyRemediationActionHygieneCommand: positionStrategyRemediation?.remediationActionHygieneCommand || positionStrategyRemediation?.remediationFlat?.actions?.hygieneCommand || null,
    positionStrategyRemediationActionNormalizeDryRunCommand: positionStrategyRemediation?.remediationActionNormalizeDryRunCommand || positionStrategyRemediation?.remediationFlat?.actions?.normalizeDryRunCommand || null,
    positionStrategyRemediationActionNormalizeApplyCommand: positionStrategyRemediation?.remediationActionNormalizeApplyCommand || positionStrategyRemediation?.remediationFlat?.actions?.normalizeApplyCommand || null,
    positionStrategyRemediationActionRetireDryRunCommand: positionStrategyRemediation?.remediationActionRetireDryRunCommand || positionStrategyRemediation?.remediationFlat?.actions?.retireDryRunCommand || null,
    positionStrategyRemediationActionRetireApplyCommand: positionStrategyRemediation?.remediationActionRetireApplyCommand || positionStrategyRemediation?.remediationFlat?.actions?.retireApplyCommand || null,
