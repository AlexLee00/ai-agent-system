...
async function buildReport() {
  ...
  const report = {
    ...
    positionStrategyRemediationCommands: positionStrategyRemediation?.remediationSummary?.commands || null,
    ...
    positionStrategyRemediationReportCommand: positionStrategyRemediation?.remediationSummary?.commands?.report || null,
    positionStrategyRemediationHistoryCommand: positionStrategyRemediation?.remediationSummary?.commands?.history || null,
    positionStrategyRemediationRefreshCommand: positionStrategyRemediation?.remediationSummary?.commands?.refresh || null,
    positionStrategyRemediationNormalizeDryRunCommand: positionStrategyRemediation?.remediationSummary?.commands?.normalizeDryRun || null,
    positionStrategyRemediationNormalizeApplyCommand: positionStrategyRemediation?.remediationSummary?.commands?.normalizeApply || null,
    positionStrategyRemediationRetireDryRunCommand: positionStrategyRemediation?.remediationSummary?.commands?.retireDryRun || null,
    positionStrategyRemediationRetireApplyCommand: positionStrategyRemediation?.remediationSummary?.commands?.retireApply || null,
