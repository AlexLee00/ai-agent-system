...
async function buildReport() {
  ...
  const report = {
    ...
    positionStrategyRemediationNextCommand: positionStrategyRemediation?.remediationNextCommand || positionStrategyRemediation?.remediationFlat?.nextCommand || null,
