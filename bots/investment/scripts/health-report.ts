...
async function buildReport() {
  ...
  const report = {
    ...
    positionStrategyRemediationActionReportCommand: positionStrategyRemediation?.remediationActionReportCommand || positionStrategyRemediation?.remediationFlat?.actions?.reportCommand || positionStrategyRemediation?.remediationFlat?.commands?.report || null,
    positionStrategyRemediationActionHistoryCommand: positionStrategyRemediation?.remediationActionHistoryCommand || positionStrategyRemediation?.remediationFlat?.actions?.historyCommand || positionStrategyRemediation?.remediationFlat?.commands?.history || null,
    positionStrategyRemediationActionRefreshCommand: positionStrategyRemediation?.remediationActionRefreshCommand || positionStrategyRemediation?.remediationFlat?.actions?.refreshCommand || positionStrategyRemediation?.remediationFlat?.refreshCommand || positionStrategyRemediation?.remediationFlat?.commands?.refresh || null,
    positionStrategyRemediationActionHygieneCommand: positionStrategyRemediation?.remediationActionHygieneCommand || positionStrategyRemediation?.remediationFlat?.actions?.hygieneCommand || positionStrategyRemediation?.remediationFlat?.commands?.hygiene || null,
    positionStrategyRemediationActionNormalizeDryRunCommand: positionStrategyRemediation?.remediationActionNormalizeDryRunCommand || positionStrategyRemediation?.remediationFlat?.actions?.normalizeDryRunCommand || positionStrategyRemediation?.remediationFlat?.commands?.normalizeDryRun || null,
    positionStrategyRemediationActionNormalizeApplyCommand: positionStrategyRemediation?.remediationActionNormalizeApplyCommand || positionStrategyRemediation?.remediationFlat?.actions?.normalizeApplyCommand || positionStrategyRemediation?.remediationFlat?.commands?.normalizeApply || null,
    positionStrategyRemediationActionRetireDryRunCommand: positionStrategyRemediation?.remediationActionRetireDryRunCommand || positionStrategyRemediation?.remediationFlat?.actions?.retireDryRunCommand || positionStrategyRemediation?.remediationFlat?.commands?.retireDryRun || null,
    positionStrategyRemediationActionRetireApplyCommand: positionStrategyRemediation?.remediationActionRetireApplyCommand || positionStrategyRemediation?.remediationFlat?.actions?.retireApplyCommand || positionStrategyRemediation?.remediationFlat?.commands?.retireApply || null,
