    ...
    },
    {
      ...
      lines: report.positionStrategyAudit
        ? [
            ...
            `  remediation refresh: ${report.positionStrategyHygiene?.remediationPlan?.remediationRefreshCommand || 'npm --prefix /Users/alexlee/projects/ai-agent-system/bots/investment run runtime:position-strategy-remediation-refresh -- --json'}`,
