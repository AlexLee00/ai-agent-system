...
async function buildReport() {
  ...
  const report = {
    ...
    positionStrategyRemediationHistory,
    positionStrategyRemediationTrend: positionStrategyRemediation?.remediationFlat?.trend || positionStrategyRemediation?.remediationTrend || null,
