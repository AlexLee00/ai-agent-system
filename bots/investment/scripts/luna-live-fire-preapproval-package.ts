...
const LIVE_CUTOVER_APPLY_COMMAND = 'npm --prefix /Users/alexlee/projects/ai-agent-system/bots/investment run -s runtime:luna-live-fire-cutover -- --apply --confirm=enable-luna-live-fire --max-daily-usdt=200 --max-open=5 --enable-position-dispatch --json';
