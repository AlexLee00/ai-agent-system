...
export const LUNA_COMPONENT_REGISTRY_SEED = Object.freeze([
  ...
  { component: 'learned-regime-bias', currentMode: 'shadow', targetMode: 'active_router_bias', criteria: { durationWeeks: 4, minSamplesPerFamilyRegime: 30, virtualExpectancyDeltaPositive: true, evidence: 'luna_regime_weight_snapshots' }, notes: 'Self-evolution loop; regime-weight-learner adaptive weights vs BASE applied via strategy-router LUNA_LEARNED_BIAS_MODE; promote shadow->active through registry instead of manual env flag' },
