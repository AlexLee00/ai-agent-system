...
- crypto/KIS/overseas 게시글은 번역 오류와 추상적 문장 생성을 줄이기 위해 기본 deterministic formatter를 사용한다. LLM 초안은 각각 `EDUX_CRYPTO_FORMATTER_MODE=llm`, `EDUX_KIS_FORMATTER_MODE=llm`, `EDUX_OVERSEAS_FORMATTER_MODE=llm`일 때만 사용한다.
