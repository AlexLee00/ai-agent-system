...
```
bots/sigma/skills/data-quality-guard/
...
```
bots/sigma/elixir/lib/sigma/v2/
├ (기존 31차 설계)
...
### 7.3 §3 `bots/sigma/skills/` 5개 SKILL.md 추가
...
새 파일: `bots/sigma/skills/.claude-plugin/plugin.json`
...
```
[ ] bots/sigma/skills/.claude-plugin/plugin.json 생성
[ ] 5개 skill 디렉토리 + SKILL.md (각 3~6KB)
[ ] bots/sigma/elixir/lib/sigma/v2/telemetry.ex skeleton
[ ] bots/sigma/elixir/lib/sigma/v2/memory/l2_pgvector.ex skeleton
