...
function _scanBotFiles() {
  const fixed = [
    ...
    'bots/investment/scripts/runtime-luna-ops-scheduler.ts',
    'bots/investment/scripts/luna-live-fire-watchdog.ts',
    'bots/investment/scripts/runtime-luna-entry-trigger-diagnose.ts',
...
module.exports = {
  ...
  LOGS: {
    ...
    crypto:   '/tmp/ai.luna.marketdata-mcp.log',
    domestic: '/tmp/elixir-supervisor.log',
    overseas: runtimePaths.logPath('luna-commander.log'),
