 ...
 * 3. test-green    — 리팩토링 후 테스트 green + 자동 롤백
 * 4. complexity    — 복잡도 증가 차단
 * 5. dependency    — 순환 의존성 차단
 * 6. verify-loop   — 실패 시 자동 수정 재시도 (최대 3회)
 */
...
export function runRefactorSafetyCheck(
  ...
  const allPass = typeCheck.pass && complexity.pass && dependency.pass;
