...
const { jaenongCommandRoute } = require('../lib/routes/jaenong-command');
...
export function registerHubRoutes(app: Express, opts: HubRouteOptions): void {
  ...
  app.post('/hub/luna/jaenong-command', generalLimiter, jaenongCommandRoute);
  ...
  app.get('/hub/llm/jobs/:id', generalLimiter, llmJobStatusRoute);
  app.get('/hub/llm/gateway-contract', generalLimiter, llmGatewayContractRoute);
