...
function unitSmokeScripts(): string[] {
  ...
  return [
    ...
    'agent-inventory-audit-smoke.ts',
    'retired-team-selector-gate-smoke.ts',
    'planned-team-route-block-smoke.ts',
    'luna-investment-alias-dedupe-smoke.ts',
    'llm-route-target-classification-smoke.ts',
    ...
    'gemini-disabled-guard-smoke.ts',
    'llm-gemini-residue-audit.ts',
    ...
    'luna-meeting-callback-smoke.ts',
  ];
}
