...
const CORE_LAUNCHD_SERVICES: LaunchdService[] = [
  ...
  { id: 'ai.luna.marketdata-mcp', name: '루나팀 마켓데이터 MCP' },
  { id: 'ai.elixir.supervisor', name: '루나팀 엘릭서 슈퍼바이저' },
  { id: 'ai.investment.runtime-autopilot', name: '루나팀 런타임 오토파일럿' },
  { id: 'ai.luna.ops-scheduler', name: '루나팀 운영 스케줄러' },
