...
const NEW_AGENTS = [
  { name: 'darwin', display_name: '다윈', team: 'darwin', role: 'leader', specialty: '연구총괄+사이클오케스트레이션', llm_model: 'anthropic', dot_character: { color: '#6366f1', accessory: 'crown' } },
  { name: 'neuron', display_name: '뉴런', team: 'darwin', role: 'searcher', specialty: 'AI/멀티에이전트기술서칭(arXiv cs.AI)', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#8b5cf6', accessory: 'magnifier' } },
  { name: 'gold-r', display_name: '골드', team: 'darwin', role: 'searcher', specialty: '투자/트레이딩전략서칭(arXiv q-fin)', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#f59e0b', accessory: 'magnifier' } },
  { name: 'ink', display_name: '잉크', team: 'darwin', role: 'searcher', specialty: '콘텐츠/SEO/블로그서칭', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#3b82f6', accessory: 'magnifier' } },
  { name: 'gavel', display_name: '가벨', team: 'darwin', role: 'searcher', specialty: '법률/SW감정서칭', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#64748b', accessory: 'magnifier' } },
  { name: 'matrix-r', display_name: '매트릭스', team: 'darwin', role: 'searcher', specialty: '데이터사이언스/분석서칭', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#06b6d4', accessory: 'magnifier' } },
  { name: 'frame', display_name: '프레임', team: 'darwin', role: 'searcher', specialty: '영상/편집기술서칭', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#ec4899', accessory: 'magnifier' } },
  { name: 'gear', display_name: '기어', team: 'darwin', role: 'searcher', specialty: '시스템/인프라/보안서칭', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#10b981', accessory: 'magnifier' } },
  { name: 'pulse', display_name: '펄스', team: 'darwin', role: 'searcher', specialty: '마케팅/수익화서칭', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#ef4444', accessory: 'magnifier' } },
  { name: 'edison', display_name: '에디슨', team: 'darwin', role: 'builder', specialty: '프로토타입구현+실험코드', llm_model: 'anthropic', dot_character: { color: '#f97316', accessory: 'glasses' } },
  ...
  { name: 'medic', display_name: '메딕', team: 'darwin', role: 'diagnostician', specialty: '저성과에이전트진단+개선', llm_model: 'anthropic', dot_character: { color: '#059669', accessory: 'cross' } },
  { name: 'scholar', display_name: '스칼라', team: 'darwin', role: 'researcher', specialty: '심층연구+논문분석', llm_model: 'anthropic', dot_character: { color: '#4f46e5', accessory: 'book' } },
  { name: 'mentor', display_name: '멘토', team: 'darwin', role: 'trainer', specialty: '에이전트재교육+프롬프트튜닝', llm_model: 'anthropic', dot_character: { color: '#a855f7', accessory: 'book' } },

  { name: 'justin', display_name: '저스틴', team: 'justin', role: 'leader', specialty: '감정총괄+사건배정+최종검토', llm_model: 'anthropic', dot_character: { color: '#64748b', accessory: 'crown' } },
  ...
  { name: 'lens', display_name: '렌즈', team: 'justin', role: 'analyst', specialty: '소스코드분석전문', llm_model: 'anthropic', dot_character: { color: '#6366f1', accessory: 'magnifier' } },
  { name: 'garam', display_name: '가람', team: 'justin', role: 'searcher', specialty: '국내판례서칭(대법원+하급심)', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#14b8a6', accessory: 'magnifier' } },
  ...
  { name: 'quill', display_name: '퀼', team: 'justin', role: 'writer', specialty: '감정서초안작성', llm_model: 'anthropic', dot_character: { color: '#8b5cf6', accessory: 'pen' } },
  { name: 'balance', display_name: '밸런스', team: 'justin', role: 'reviewer', specialty: '감정서품질검증+객관성심사', llm_model: 'anthropic', dot_character: { color: '#10b981', accessory: 'shield' } },
  ...
  { name: 'sigma', display_name: '시그마', team: 'sigma', role: 'leader', specialty: 'CDO+데이터전략수립', llm_model: 'anthropic', dot_character: { color: '#06b6d4', accessory: 'crown' } },
  { name: 'pipe', display_name: '파이프', team: 'sigma', role: 'engineer', specialty: '데이터파이프라인+ETL+품질관리', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#22c55e', accessory: 'glasses' } },
  ...
  { name: 'oracle-ds', display_name: '오라클DS', team: 'sigma', role: 'ml_engineer', specialty: 'ML엔지니어+모델학습+추론최적화', llm_model: 'anthropic', dot_character: { color: '#8b5cf6', accessory: 'glasses' } },
  ...
  { name: 'curator', display_name: '큐레이터', team: 'sigma', role: 'governance', specialty: '데이터거버넌스+품질기준+카탈로그', llm_model: 'local/qwen2.5-7b', dot_character: { color: '#14b8a6', accessory: 'book' } },
