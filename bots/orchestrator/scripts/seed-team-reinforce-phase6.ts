...
const NEW_AGENTS = [
  ...
  { name: 'weaver', display_name: '위버', team: 'darwin', role: 'synthesizer', specialty: '다수서칭결과통합+연구맵작성', dot_character: { color: '#7c3aed', accessory: 'book' }, config: runtimeConfig('darwin', 'synthesis', 'darwin.agent_policy') },
  { name: 'ledger', display_name: '레저', team: 'darwin', role: 'source_auditor', specialty: '소스신뢰도평가+인용가능성검증', dot_character: { color: '#0f766e', accessory: 'shield' }, config: runtimeConfig('darwin', 'review', 'darwin.agent_policy') },
  { name: 'forge', display_name: '포지', team: 'darwin', role: 'replicator', specialty: '논문주장재현+실험재실행', dot_character: { color: '#ea580c', accessory: 'glasses' }, config: runtimeConfig('darwin', 'research', 'darwin.agent_policy') },
  { name: 'rift', display_name: '리프트', team: 'darwin', role: 'counterexample', specialty: '반례탐색+실패조건발굴', dot_character: { color: '#dc2626', accessory: 'magnifier' }, config: runtimeConfig('darwin', 'review', 'darwin.agent_policy') },
  { name: 'frontier', display_name: '프론티어', team: 'darwin', role: 'searcher', specialty: '최신성우선서칭(arXiv/GitHub/new repo)', dot_character: { color: '#2563eb', accessory: 'magnifier' }, config: runtimeConfig('darwin', 'research', 'darwin.agent_policy') },
  ...
  { name: 'sentry-d', display_name: '센트리D', team: 'sigma', role: 'qa_sentinel', specialty: '누락/이상치/드리프트감시', dot_character: { color: '#dc2626', accessory: 'shield' }, config: runtimeConfig('sigma', 'quality', 'sigma.agent_policy') },
  { name: 'cause', display_name: '코즈', team: 'sigma', role: 'causal_analyst', specialty: '상관/인과구분+혼입변수검토', dot_character: { color: '#2563eb', accessory: 'compass' }, config: runtimeConfig('sigma', 'analysis', 'sigma.agent_policy') },
  { name: 'scope', display_name: '스코프', team: 'sigma', role: 'observability', specialty: '지표/경보/대시보드관측설계', dot_character: { color: '#f97316', accessory: 'chart' }, config: runtimeConfig('sigma', 'analysis', 'sigma.agent_policy') },
  { name: 'explorer-d', display_name: '익스플로러D', team: 'sigma', role: 'analyst', specialty: '신규가설탐색+공격적피처실험', dot_character: { color: '#22c55e', accessory: 'magnifier' }, config: runtimeConfig('sigma', 'analysis', 'sigma.agent_policy') },
  { name: 'conservative-d', display_name: '컨서버티브D', team: 'sigma', role: 'reviewer', specialty: '재현성우선+안정성중심검토', dot_character: { color: '#64748b', accessory: 'shield' }, config: runtimeConfig('sigma', 'quality', 'sigma.agent_policy') },
  { name: 'skeptic-d', display_name: '스켑틱D', team: 'sigma', role: 'qa_sentinel', specialty: '데이터누수/샘플편향/과적합탐지', dot_character: { color: '#b91c1c', accessory: 'glasses' }, config: runtimeConfig('sigma', 'quality', 'sigma.agent_policy') },
];
