...
const AGENTS = [
  ...
  { name: 'luna', display_name: '루나', team: 'luna', role: 'leader', specialty: '펀드매니저', code_path: 'bots/investment/team/luna.ts', dot_character: { color: '#f59e0b', accessory: 'crown' }, config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'commander' } },
