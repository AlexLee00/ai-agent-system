...
const AGENTS = [
  { name: 'blo', display_name: '블로', team: 'blog', role: 'leader', specialty: '블로그 팀장', code_path: 'bots/blog/lib/blo.js', config: { llm_management: 'runtime-managed', runtime_team: 'blog', runtime_purpose: 'default' } },
  { name: 'pos', display_name: '포스', team: 'blog', role: 'writer', specialty: 'IT기술작가', code_path: 'bots/blog/lib/pos-writer.js', dot_character: { color: '#6366f1', accessory: 'glasses' }, config: { llm_management: 'runtime-managed', runtime_team: 'blog', runtime_purpose: 'writer' } },
  { name: 'gems', display_name: '젬스', team: 'blog', role: 'writer', specialty: '감성에세이작가', code_path: 'bots/blog/lib/gems-writer.js', dot_character: { color: '#a855f7', accessory: 'pen' }, config: { llm_management: 'runtime-managed', runtime_team: 'blog', runtime_purpose: 'writer' } },
  { name: 'richer', display_name: '리처', team: 'blog', role: 'researcher', specialty: '자료수집', code_path: 'bots/blog/lib/richer.js', config: { llm_management: 'runtime-managed', runtime_team: 'blog', runtime_purpose: 'default' } },
  ...
  { name: 'luna', display_name: '루나', team: 'luna', role: 'leader', specialty: '펀드매니저', code_path: 'bots/investment/team/luna.js', dot_character: { color: '#f59e0b', accessory: 'crown' }, config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'commander' } },
  { name: 'aria', display_name: '아리아', team: 'luna', role: 'analyst', specialty: '기술분석', code_path: 'bots/investment/team/aria.js', dot_character: { color: '#ef4444', accessory: 'chart' }, config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'analyst' } },
  { name: 'sentinel', display_name: '센티널', team: 'luna', role: 'analyst', specialty: '외부정보감시', code_path: 'bots/investment/team/sentinel.js', config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'analyst' } },
  { name: 'oracle', display_name: '오라클', team: 'luna', role: 'analyst', specialty: '기술분석', code_path: 'bots/investment/team/oracle.js', config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'analyst' } },
  ...
  { name: 'scout', display_name: '스카우트', team: 'luna', role: 'analyst', specialty: '토스시장스캔/시장인텔리전스', code_path: 'bots/investment/team/scout.js', dot_character: { color: '#0ea5e9', accessory: 'radar' }, config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'analyst' } },
  { name: 'nemesis', display_name: '네메시스', team: 'luna', role: 'risk', specialty: '리스크매니저', code_path: 'bots/investment/team/nemesis.js', dot_character: { color: '#64748b', accessory: 'shield' }, config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'validator' } },
  { name: 'zeus', display_name: '제우스', team: 'luna', role: 'executor', specialty: '주문실행', code_path: 'bots/investment/team/zeus.js', config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'validator' } },
  { name: 'athena', display_name: '아테나', team: 'luna', role: 'executor', specialty: '주문실행', code_path: 'bots/investment/team/athena.js', config: { llm_management: 'runtime-managed', runtime_team: 'luna', runtime_purpose: 'validator' } },
