defmodule Darwin.V2.Cycle.Learn do
  @moduledoc "다윈 V2 Learn 사이클 GenServer — 7단계 R&D 루프의 Learn 단계."
  ...
  @impl GenServer
  def init(_opts) do
    Logger.info("[darwin/cycle.learn] Learn 단계 기동")
  ...
  def handle_call(:status, _from, state) do
    {:reply, Map.put(state, :phase, :learn), state}
  end
