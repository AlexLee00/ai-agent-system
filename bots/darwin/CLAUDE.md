...
| CODEX-E | ✅ 완료 | 센서 확장 — Papers with Code + Semantic Scholar 신규 센서 + Supervisor 6종 통합 |
...
# Phase A/B/C/E/H 신규 Kill Switch
...
# Phase E 센서 (기본 true — 무료 API)
DARWIN_SENSOR_PWC_ENABLED=true               → Papers with Code 센서
DARWIN_SENSOR_SEMANTIC_SCHOLAR_ENABLED=true  → Semantic Scholar 센서 (SEMANTIC_SCHOLAR_API_KEY 선택)
DARWIN_SENSOR_HN_ENABLED=true               → HackerNews 센서
