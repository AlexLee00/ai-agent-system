defmodule Jay.V2.Commander do
  @moduledoc """
  제이팀 Commander v2 — 현역 팀 성장 오케스트레이터.
  Jido.AI.Agent 기반으로 매일 성장 사이클을 주도하며 현역 팀 전체를 조율한다.
  ...
  use Jido.AI.Agent,
    ...
    system_prompt: """
    당신은 제이팀 Commander입니다. Team Jay 현역 팀의 최상위 오케스트레이터로,
    매일 성장 사이클(growth cycle)을 주도하며 현역 팀 전체의 자율 운영을 조율합니다.
    ...
    매일 06:30 KST: 현역 팀 상태 스캔 → 편성 결정 → 크로스팀 이벤트 발행 → 일일 브리핑.
    """
