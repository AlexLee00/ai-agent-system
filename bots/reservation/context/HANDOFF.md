...
| 🔴 | 🔴 | `BUG-017` | 픽코 자동 등록 실패 | ska | 7시간 전 |
| 🔴 | 🔴 | `BUG-018` | 픽코 자동 등록 실패 | ska | 0분 전 |

**최근 해결:**
- ✅ `BUG-006` **BOOT 재시작 시 파일명 텔레그램 출력 이슈**
  버그 최초 보고 (46일 전)
- ✅ `BUG-012` **pickko-member.js 회원 등록 중 Runtime.callFunctionOn 타임아웃 발생**
  010-9075-3796 유선욱 고객 회원 등록 중 Runtime.callFunctionOn timed out 오류 발생. Puppeteer protocolTimeout이 부족하거나 다른 원인으로 인해 회원 등록 프로세스가 완료되지 못함. (46일 전)
...
{"error":"Connection Error: Connection was never established or has been closed already"} (46일 전)
