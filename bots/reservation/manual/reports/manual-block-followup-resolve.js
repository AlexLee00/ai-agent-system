...
/**
 * manual-block-followup-resolve.js — manual 등록 후속 네이버 차단 수동 처리 결과를 원장에 반영
 *
 * 사용법:
 *   node manual/reports/manual-block-followup-resolve.js --phone=01027922221 --date=2026-03-27 --start=12:00
 *   node manual/reports/manual-block-followup-resolve.js --from=2026-03-21 --all-open --dry-run
 *   node manual/reports/manual-block-followup-resolve.js --from=2026-03-21 --all-open
 *
 * 출력 (stdout JSON):
 *   { success: true, updated: N, message }
 */
