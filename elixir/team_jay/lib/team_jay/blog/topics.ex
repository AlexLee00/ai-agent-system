defmodule TeamJay.Blog.Topics do
  ...
  def execution(target), do: "blog:execution:#{target}"
  def execution_result(target), do: "blog:execution_result:#{target}"
  def execution_alert(target), do: "blog:execution_alert:#{target}"
