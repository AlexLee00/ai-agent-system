defmodule TeamJay.Investment.Phase5CircuitSuite do
  @moduledoc """
  Phase 5.5-5 서킷 브레이커 scaffold를 기본 시장 세트로 검증하는 suite.
  """

  alias TeamJay.Investment.Phase5CircuitHarness
