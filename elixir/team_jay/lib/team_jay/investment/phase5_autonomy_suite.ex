defmodule TeamJay.Investment.Phase5AutonomySuite do
  @moduledoc """
  Phase 5.5-9 완전자율 연속 루프 coordinator scaffold를 기본 시장 세트로 검증하는 suite.
  """

  alias TeamJay.Investment.Phase5AutonomyHarness
  ...
  def run_defaults(opts \\ []) do
    ...
    rows =
      Enum.map(PipelineStarter.default_pipelines(), fn %{exchange: exchange, symbol: symbol} ->
        result =
          Phase5AutonomyHarness.run_once(
            exchange: exchange,
            symbol: symbol,
