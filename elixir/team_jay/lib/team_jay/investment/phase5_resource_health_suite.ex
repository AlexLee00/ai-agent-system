defmodule TeamJay.Investment.Phase5ResourceHealthSuite do
  @moduledoc """
  Phase 5 resource_health scaffold를 기본 시장 세트로 검증하는 suite.
  """

  alias TeamJay.Investment.Phase5ResourceHealthHarness
  ...
  def run_defaults(opts \\ []) do
    ...
    rows =
      Enum.map(PipelineStarter.default_pipelines(), fn %{exchange: exchange, symbol: symbol} ->
        result =
          Phase5ResourceHealthHarness.run_once(
            exchange: exchange,
            symbol: symbol,
