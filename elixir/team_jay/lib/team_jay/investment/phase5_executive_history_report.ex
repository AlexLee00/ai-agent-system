defmodule TeamJay.Investment.Phase5ExecutiveHistoryReport do
  @moduledoc """
  Phase 5 executive history를 사람이 읽기 쉬운 텍스트로 정리한다.
  """

  alias TeamJay.Investment.Phase5ExecutiveHistory

  def run_defaults(opts \\ []) do
    result = Phase5ExecutiveHistory.run_defaults(opts)
  ...
  def render(result) do
    header =
      case result.status do
        :phase5_executive_advanced -> "Phase 5 executive history ADVANCED"
        :phase5_executive_ready -> "Phase 5 executive history READY"
        :phase5_executive_stable -> "Phase 5 executive history STABLE"
        _ -> "Phase 5 executive history CHECK"
      end
