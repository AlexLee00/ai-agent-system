defmodule TeamJay.Investment.Phase5StrategyHarness do
  @moduledoc """
  Phase 5-C 전략 자동 적용 scaffold가 strategy_update까지 도달하는지 확인하는 harness.
  """
  ...
  defp loop(symbol, deadline, events) do
    ...
    receive do
      {:investment_event, topic, payload} ->
        ...
        if topic == Topics.strategy_updates(symbol) do
          %{
            status: :ok,
            completed: true,
