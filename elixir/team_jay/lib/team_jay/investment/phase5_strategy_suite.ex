defmodule TeamJay.Investment.Phase5StrategySuite do
  @moduledoc """
  Phase 5-C 전략 자동 적용 scaffold를 기본 시장 세트로 검증하는 suite.
  """

  alias TeamJay.Investment.Phase5StrategyHarness
  ...
  def run_defaults(opts \\ []) do
    ...
    rows =
      Enum.map(PipelineStarter.default_pipelines(), fn %{exchange: exchange, symbol: symbol} ->
        result =
          Phase5StrategyHarness.run_once(
            exchange: exchange,
            symbol: symbol,
