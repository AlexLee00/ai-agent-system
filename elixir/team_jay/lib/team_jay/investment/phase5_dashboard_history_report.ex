defmodule TeamJay.Investment.Phase5DashboardHistoryReport do
  @moduledoc """
  Phase 5 dashboard history를 사람이 읽기 쉬운 텍스트로 정리한다.
  """

  alias TeamJay.Investment.Phase5DashboardHistory

  def run_defaults(opts \\ []) do
    result = Phase5DashboardHistory.run_defaults(opts)
  ...
  def render(result) do
    header =
      case result.status do
        :phase5_dashboard_advanced -> "Phase 5 dashboard history ADVANCED"
        :phase5_dashboard_ready -> "Phase 5 dashboard history READY"
        :phase5_dashboard_stable -> "Phase 5 dashboard history STABLE"
        _ -> "Phase 5 dashboard history CHECK"
      end
