defmodule TeamJay.Investment.Phase5CommandCenterHistoryReport do
  @moduledoc """
  Phase 5 command center history를 사람이 읽기 쉬운 텍스트로 정리한다.
  """

  alias TeamJay.Investment.Phase5CommandCenterHistory

  def run_defaults(opts \\ []) do
    result = Phase5CommandCenterHistory.run_defaults(opts)
  ...
  def render(result) do
    header =
      case result.status do
        :phase5_command_center_advanced -> "Phase 5 command center history ADVANCED"
        :phase5_command_center_ready -> "Phase 5 command center history READY"
        :phase5_command_center_stable -> "Phase 5 command center history STABLE"
        _ -> "Phase 5 command center history CHECK"
      end
