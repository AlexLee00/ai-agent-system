defmodule TeamJay.Investment.Phase5ModeSuite do
  @moduledoc """
  Phase 5-E 장기/단기 동적 전환 scaffold를 기본 시장 세트로 검증하는 suite.
  """

  alias TeamJay.Investment.Phase5ModeHarness
