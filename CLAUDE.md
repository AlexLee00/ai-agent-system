...
## 🌟 Karpathy 행동 가이드라인 (Skills 적용 — 2026-05-12)

> 출처: [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills) (71k+ stars, viral 2026!)
> 기반: Andrej Karpathy 2026-01-26 X 트윗 — LLM 코딩 실패 모드 분석
> 적용일: 2026-05-12 01:01 KST (메티 직접 적용, 마스터 옵션 A 결정!)
