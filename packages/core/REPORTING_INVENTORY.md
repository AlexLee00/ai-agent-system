...
3. remaining direct `rag.store(...)` writers, especially blog richer side and any leftover non-shared callers, also absorb into reporting-hub rag target composition
