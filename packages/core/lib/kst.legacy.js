...
function resolveSourcePath() {
  ...
  const candidates = [
    path.join(__dirname, 'kst.ts'),
    path.join(repoRoot, 'packages/core/lib/kst.ts'),
    path.join(__dirname, '../../../../packages/core/lib/kst.ts'),
    path.join(__dirname, '../../../../../packages/core/lib/kst.ts'),
  ];
  ...
  throw new Error(`Unable to locate kst.ts runtime source (checked: ${candidates.join(', ')})`);
}
