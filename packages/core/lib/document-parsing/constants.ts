...
const WARNING_CODES = Object.freeze({
  ...
  DOCX_EMPTY_DOCUMENT: 'docx_empty_document',
  DOCX_TRUNCATED: 'docx_truncated',
  DOCX_HEADER_FOOTER_MISSING: 'docx_header_footer_missing',
  DOC_PARSER_UNAVAILABLE: 'doc_parser_unavailable',
  DOC_TEXT_NOT_FOUND: 'doc_text_not_found',
  ...
  IMAGE_TEXT_SPARSE: 'image_text_sparse',
