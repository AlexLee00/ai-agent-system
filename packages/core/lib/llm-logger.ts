...
const PRICING: Record<string, { input: number; output: number }> = {
  ...
  'gemini-cli-oauth/gemini-2.5-flash-lite': { input: 0, output: 0 },
  'gemini-cli-oauth/gemini-2.5-flash': { input: 0, output: 0 },
  'gemini-cli-oauth/gemini-2.5-pro': { input: 0, output: 0 },
  'gemini-codeassist-oauth/gemini-2.5-pro': { input: 0, output: 0 },
  'google-gemini-cli/gemini-2.5-flash-lite': { input: 0, output: 0 },
  'google-gemini-cli/gemini-2.5-flash': { input: 0, output: 0 },
  'google-gemini-cli/gemini-2.5-pro': { input: 0, output: 0 },
