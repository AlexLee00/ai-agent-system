import { z } from 'zod';
import { EventRecordSchema } from './event-lake.core';
import { MessageEnvelopeSchema } from './message-envelope.core';
import { MarketRegimeResultSchema } from '../../../bots/investment/shared/market-regime.core';
