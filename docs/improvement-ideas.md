...
| 8 | **LU-030 펀드매니저** | 📋 다음 | claude-sonnet-4-6 오케스트레이터 |
| 9 | **LU-036 리스크 매니저 v2** | 📋 맥북 | LLM 강화 |
| 10 | **LU-037 백테스팅 엔진** | 📋 맥북 | 규칙 기반 |
| 11 | **LU-038 몰리 v2** | 📋 맥북 | TP/SL 자동화 |
| 12 | **CL-004** Dev/OPS 분리 | 📋 맥북 | ska+invest 안정화 확인 후 |
| 13 | **CL-006** 코드 리팩토링 | 📋 맥북 | 기능 안정화 후 |
| 14 | **LU-025** OPS 전환 | 📋 **맨 마지막** | 맥북 안정화 완료 후 |
| 15 | **CL-005** GUI / 맥미니 이전 | 📋 Phase 2 | 맥미니 구매 후 |
...
|---|------|--------|---------|-------------------|------|
| LU-030 | 루나 펀드매니저 오케스트레이터 | 루나 | claude-sonnet-4-6 | claude-sonnet-4-6 | 📋 대기 |
...
| LU-035 | 강세/약세 리서처 토론 엔진 | 새 봇 ×2 | claude-haiku-4-5 | claude-haiku-4-5 | 📋 대기 |
| LU-036 | 리스크 매니저 v2 (LLM 강화) | 업그레이드 | claude-haiku-4-5 | claude-haiku-4-5 | 📋 대기 |
| LU-037 | 백테스팅 엔진 | 새 봇 | 규칙 기반 | ollama/deepseek-r1:32b | 📋 대기 |
| LU-038 | 몰리 v2 업비트 TP/SL | 업그레이드 | LLM 없음 | LLM 없음 | 📋 대기 |
| LU-039 | ChromaDB 학습 루프 | 루나 | - | - | 📋 대기 |
