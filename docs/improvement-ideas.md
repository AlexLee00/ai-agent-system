...
1. WorkerAIWorkspace 권한별 분기 적용
2. feedback → RAG adapter 추가
3. 스카 n8n node화 2차

### 3순위

1. 스카 RAG retrieval-first 활용 연결
2. feedback 주간 품질 자동화
3. reporting-hub 잔여 producer 정리

### 4순위

1. 맥미니 이관 체크리스트 실행 준비
2. Agent-to-UI / Generative UI 실험 범위 정의
