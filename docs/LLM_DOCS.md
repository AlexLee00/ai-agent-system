  ...
  "content": [
    {
      ...
      // 1시간 TTL: { "type": "ephemeral", "ttl": 3600 }
    },
...
| 모델 ID | 컨텍스트 | RPM | TPM | RPD | 속도 (TTFT) |
|---------|---------|-----|-----|-----|-----------|
| `llama-3.1-8b-instant` | 128K | 30 | 6,000 | 14,400 | **203ms** |
| `llama-4-scout-17b-16e-instruct` | 128K | 30 | **30,000** | 1,000 | 211ms |
| `llama-3.3-70b-versatile` | 128K | 30 | 12,000 | 1,000 | 225ms |

**속도**: Gemini보다 약 3배 빠름. 에이전트 루프에 최적.
**Rate limit**: 조직 단위 적용. 캐시 토큰 미포함.
