...
운영 중:
  1. 제이 (메인봇/OpenClaw) — 총괄 허브, 오케스트레이션
     └─ 라이트(Write) — 문서 관리, 팀장회의록, 일일 리포트 (bots/orchestrator/src/write.js)
...
| 날짜 | 변경 |
|------|------|
| 2026-04-03 | Phase 6 구현 완료: 스킬31+MCP4+워크플로우4, 3계층동적선택(Agent→Skill→Tool), 90에이전트, JSONB팀추적, 런타임셀렉터전팀분리, 블로그댓글859줄 |
| 2026-04-03 | P1수정: hermes→swift+role정규화+selectBestAgent팀격리+동적선택(블로6명+루나11명후보) |
| 2026-04-03 | Phase0.5~3 완료: 3팀신설(연구15+감정10+데이터6)+루나보강12+블로보강10+경쟁활성화+UI강화 |
