...
Layer 2: agentskills.io 포맷 (Anthropic 공식 표준)  ← NEW!
  - packages/skills/sigma/*.md (각 skill 마크다운)
...
```elixir
# elixir/team_jay/lib/team_jay/sigma/v2/commander.ex
defmodule Sigma.V2.Commander do
  use Jido.AI.Agent,
    name: "sigma_commander",
    model: :smart,
...
# elixir/team_jay/lib/team_jay/sigma/v2/skill/data_quality_guard.ex
defmodule Sigma.V2.Skill.DataQualityGuard do
  use Jido.Action,
    name: "data_quality_guard",
    description: "TODO",
  ...
  @impl Jido.Action
  def run(params, _context) do
    # TODO Phase 1: port from packages/core/lib/skills/sigma/data-quality-guard.ts
...
```
[ ] packages/skills/sigma/ 디렉토리 + 5개 .md 파일 (agentskills.io 포맷)
