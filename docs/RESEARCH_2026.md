...
| 3 | **Claude Opus 4.5** | 코딩, 에이전트 워크플로우 | SWE-bench 1위, Elo 1510 |
| 4 | **Claude Sonnet 4.5** | 자율 에이전트, 멀티파일 추론 | 프로덕션 에이전트 최적 |
...
| Claude Sonnet 4.5 | 중간 | 중간 | 복잡한 판단 |
...
|------|---------|------------------|
| 투자봇 오케스트레이터 | claude-sonnet-4-6 | **유지** (복잡한 판단), Groq 보조 검토 |
...
*작성: 2026-02-27 | 내일 (2026-02-28) LLM 모델 문서 학습 + 매출 예측 엔진 설계에 활용*
