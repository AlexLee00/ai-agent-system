...
> 버전 v0.6 (2026-06-13) · 작성: 메티 · 상태: 실험판 + 성장 통합 + **재설계 정합(§21)·사용 시뮬레이션(§22)·3시장 회의 체계(§23)** · 보강=LUNA_BOOST_DESIGN.md · 적용 검토=LUNA_BOOST_APPLY_REVIEW.md · 성장=LUNA_GROWTH_REINFORCEMENT.md
...
- 재설계 §7 타임라인 갱신 연동: `04:50 게이트 산출 → 05:00 아침 통합 → 09:00 국내 → 16:00 국내 debrief → 22:00 미 점검 → 23:30 미국장 → 상시 crypto`.
