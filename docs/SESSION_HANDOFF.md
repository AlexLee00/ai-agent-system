...
- 비디오
  ...
  - 2026-03-22 검증 기준선은 `scene_count=42`, `segment_count=5`, `sync_confidence=0.6`, `keyword=5`, `unmatched=0`까지 올라왔다. 오프라인 `narration-analyzer` fallback 세그먼트 granularity 보강이 효과를 냈고, 다음 1순위는 `preview_ms` 원장화와 preview/final render 품질 검증이다.
