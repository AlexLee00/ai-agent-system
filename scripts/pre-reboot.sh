...
stop_service_if_registered "ai.telegram.callback-poller" "텔레그램 콜백 poller"
stop_service_if_registered "ai.elixir.supervisor" "Team Jay 대시보드/Elixir supervisor"
stop_service_if_registered "ai.sigma.mcp-server" "Sigma MCP 서버"
